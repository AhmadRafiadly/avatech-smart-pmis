    ...
    <div class="grid grid-cols-1 lg:grid-cols-[260px_1fr] gap-8">
        ...
        <section class="space-y-6">
            ...
            <div data-panel="general">
                ...
                @if (\Illuminate\Support\Facades\Route::has('testing-evidence.index'))
                    <div class="bg-violet-50/70 border border-violet-200 rounded-2xl p-6 mb-5 flex items-start justify-between gap-4 flex-wrap">
                        <div class="flex items-start gap-4 min-w-0">
                            ...
                            <div class="min-w-0">
                                <h3 class="text-[15px] font-bold text-[#1E1B4B]">QA Evidence</h3>
                                <p class="text-[12.5px] text-slate-500 mt-1 max-w-xl">
                                    Support utility read-only untuk ringkasan bukti Black-Box, UAT, Validasi LLM, dan TestSprite.
                                </p>
                            </div>
                        </div>
                ...
                @if (\Illuminate\Support\Facades\Route::has('metric-reference.index'))
                    <div class="bg-violet-50/70 border border-violet-200 rounded-2xl p-6 mb-5 flex items-start justify-between gap-4 flex-wrap">
                        <div class="flex items-start gap-4 min-w-0">
                            <div class="w-11 h-11 rounded-xl bg-white text-violet-700 flex items-center justify-center border border-violet-100 flex-shrink-0">
                            ...
                            <div class="min-w-0">
                                <h3 class="text-[15px] font-bold text-[#1E1B4B]">Metric Reference</h3>
                                <p class="text-[12.5px] text-slate-500 mt-1 max-w-xl">
                                    Referensi rumus dan sumber data untuk metric dashboard, AI monitor, dan system health.
                                </p>
                            </div>
                        </div>
                        <a href="{{ route('metric-reference.index') }}" class="inline-flex items-center gap-1.5 h-9 px-4 rounded-xl bg-white border border-violet-200 text-violet-700 text-[12.5px] font-semibold hover:border-violet-400 transition">
                            <x-heroicon-o-arrow-top-right-on-square class="w-4 h-4" />
                            Buka Metric Reference
                        </a>
                    </div>
                @endif
