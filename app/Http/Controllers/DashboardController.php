    ...
    private function rolePresets(?string $role, User $user, ?Project $primaryProject): array
    {
        ...
        return match ($role) {
            'sa_qa' => [
                ...
                'firstName'        => $firstName,
                'initials'         => $initials,
                'subtitle'         => 'Selesaikan antrian QC dan retest hari ini untuk menjaga kualitas sprint.',
                'focusLine'        => $primaryProject ? 'Review QC ' . $primaryProject->name : 'Belum ada proyek di antrian Anda.',
                ...
                'quickActions'     => [
                    ['label' => 'Review QC',      'sub' => 'Buka antrian quality control', 'icon' => 'beaker',        'tileBg' => '#FEF3C7', 'tileFg' => '#92400E', 'href' => $primaryQc],
                    ...
                    ['label' => 'Projects',       'sub' => 'Semua proyek yang ditugaskan',  'icon' => 'rectangle-stack','tileBg' => '#FCE7F3', 'tileFg' => '#9D174D', 'href' => $projectsRoute],
                ],
            ],
            'uiux_designer', 'ui_ux' => [
